...
export const FLOWBITE_ICONS = {
  ...
  userCog: {
    viewBox: '0 0 24 24',
    paths: ['M10 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm-7 9a7 7 0 0 1 11.2-5.6 6.5 6.5 0 0 0-1.1 5.6H3Zm14.5 1.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm.5-6.5.4 1.1 1.1.1-.8.7.2 1.1-.9-.6-.9.6.2-1.1-.8-.7 1.1-.1.4-1.1Z']
  },
  clock: {
    viewBox: '0 0 24 24',
