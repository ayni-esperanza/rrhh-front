...
interface ApiDay { fecha: string; tipoRegistro: string; minutosNormales?: number; minutosExtras?: number; horaEntrada?: string; horaSalida?: string; lugarTrabajoId?: string; lugarTrabajo?: { nombre: string }; }
...
export class AsistenciasService {
  ...
  getById(id: string): Observable<Record<string, unknown>> { return this.http.get<Record<string, unknown>>(`${environment.apiUrl}/asistencias/${id}`); }
